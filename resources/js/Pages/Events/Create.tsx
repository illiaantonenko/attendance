...
export default function EventCreate({ categories, groups, defaultStart, defaultEnd }: Props) {
    ...
    return (
        <AuthenticatedLayout title="Створити подію">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Наприклад: Лекція з математики"
                                    required
                                />
                        ...
                        <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                            ...
                            >
                                {processing ? 'Збереження...' : 'Створити подію'}
                            </button>
                        </div>
                    </form>
                </div>
